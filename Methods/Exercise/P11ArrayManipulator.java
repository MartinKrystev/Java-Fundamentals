...
public class P11ArrayManipulator {
    public static void main(String[] args) {
        ...
        while (!input.equals("end")) {
            ...
            switch (command) {
                case "exchange":
                    int index = Integer.parseInt(commandText[1]);
                ...
                case "min":
                    ...
                    break;
                case "first":
                    int count = Integer.parseInt(commandText[1]);
                    if (count > arr.length) {
                        System.out.println("Invalid count");
                    } else {
                        if (commandText[2].equals("even")) {
                    ...
                    break;
                case "last":
                    count = Integer.parseInt(commandText[1]);
                    if (count > arr.length) {
                        System.out.println("Invalid count");
                    } else {
                        if (commandText[2].equals("even")) {
